...
class Config(BaseSettings):
    ...
    WEAVIATE_BASE_URL: str = "your weaviate base url or sandbox if running the app is streamlit cloud"
    WEAVIATE_API_KEY: str = "your weaviate api key if using sandbox"